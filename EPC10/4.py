...
medias = running_mean(residuos,25)
...
for i in range(1,len(medias)):
    sh.append(max(0,medias[i]-(media+K)+sh[i-1]))
    sl.append(max(0,(media-K)-medias[i]+sl[i-1]))
